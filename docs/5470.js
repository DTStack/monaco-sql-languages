(self.webpackChunkmonaco_languages = self.webpackChunkmonaco_languages || []).push([
	[5470],
	{
		65470: (e, t, n) => {
			'use strict';
			n.r(t), n.d(t, { setupMode: () => an, setupMode1: () => rn });
			var i,
				r,
				a,
				o,
					...
					return (
						...
						(e.prototype._getClient = function () {
							return (
								...
								this._client ||
									((this._worker = E.j6.createWebWorker({
			...
			((L = i || (i = {})).create = function (e, t) {
				return { line: e, character: t };
			}),
				(L.is = function (e) {
					var t = e;
					return ue.objectLiteral(t) && ue.number(t.line) && ue.number(t.character);
				}),
				((M = r || (r = {})).create = function (e, t, n, r) {
					if (ue.number(e) && ue.number(t) && ue.number(n) && ue.number(r))
				...
				(M.is = function (e) {
					var t = e;
					return ue.objectLiteral(t) && i.is(t.start) && i.is(t.end);
				}),
				((x = a || (a = {})).create = function (e, t) {
					return { uri: e, range: t };
				}),
				(x.is = function (e) {
					var t = e;
					return (
						ue.defined(t) && r.is(t.range) && (ue.string(t.uri) || ue.undefined(t.uri))
					);
				}),
				(function (e) {
				...
				(function (e) {
					(e.create = function (e, t, n) {
						...
						(e.is = function (e) {
							...
							return (
								ue.string(t.label) &&
								(ue.undefined(t.textEdit) || _.is(t)) &&
								(ue.undefined(t.additionalTextEdits) ||
									ue.typedArray(t.additionalTextEdits, _.is))
							);
						});
				})(c || (c = {})),
				((S = h || (h = {})).Comment = 'comment'),
				(S.Imports = 'imports'),
				(S.Region = 'region'),
				(function (e) {
					(e.create = function (e, t, n, i, r) {
						...
						return (
							ue.defined(n) && (a.startCharacter = n),
							ue.defined(i) && (a.endCharacter = i),
							ue.defined(r) && (a.kind = r),
							a
						);
					}),
						(e.is = function (e) {
							var t = e;
							return (
								ue.number(t.startLine) &&
								ue.number(t.startLine) &&
								(ue.undefined(t.startCharacter) || ue.number(t.startCharacter)) &&
								(ue.undefined(t.endCharacter) || ue.number(t.endCharacter)) &&
				...
				(function (e) {
					e.is = function (e) {
						...
						return (
							null != t &&
							(ue.number(t.value) || ue.string(t.value)) &&
							ue.string(t.target)
						);
					};
				})(f || (f = {})),
				(function (e) {
					(e.create = function (e, t, n, i, r, a) {
						...
						return (
							ue.defined(n) && (o.severity = n),
							ue.defined(i) && (o.code = i),
							ue.defined(r) && (o.source = r),
							ue.defined(a) && (o.relatedInformation = a),
							o
						);
					}),
						(e.is = function (e) {
							...
							return (
								...
								r.is(t.range) &&
								ue.string(t.message) &&
								(ue.number(t.severity) || ue.undefined(t.severity)) &&
								(ue.number(t.code) || ue.string(t.code) || ue.undefined(t.code)) &&
								(ue.string(t.source) || ue.undefined(t.source)) &&
								(ue.undefined(t.relatedInformation) ||
									ue.typedArray(t.relatedInformation, u.is))
							);
						});
				})(g || (g = {})),
				(function (e) {
				...
				(function (e) {
					(e.replace = function (e, t) {
						...
						(e.is = function (e) {
							var t = e;
							return ue.objectLiteral(t) && ue.string(t.newText) && r.is(t.range);
						});
				})(_ || (_ = {})),
				(function (e) {
					(e.create = function (e, t) {
						...
						(e.is = function (e) {
							var t = e;
							return ue.defined(t) && C.is(t.textDocument) && Array.isArray(t.edits);
						});
				})(w || (w = {})),
				(function (e) {
					(e.create = function (e, t) {
			...
			!(function () {
					...
					(e.create = function (e, t) {
						...
						(e.is = function (e) {
							...
							return (
								ue.defined(t) &&
								ue.string(t.uri) &&
								(null === t.version || ue.number(t.version))
							);
						});
				})(C || (C = {})),
				(function (e) {
				...
				(function (e) {
					(e.create = function (e, t, n) {
						...
						(e.is = function (e) {
							var t = e;
							return t && ue.string(t.newText) && r.is(t.insert) && r.is(t.replace);
						});
				})(N || (N = {})),
				(function (e) {
					e.create = function (e) {
				...
				(function (e) {
					(e.create = function (e, t) {
						...
						(e.is = function (e) {
							...
							return (
								ue.defined(t) &&
								ue.typedArray(t.diagnostics, g.is) &&
					...
					(e.create = function (e, t, n) {
						...
						(e.is = function (e) {
							...
							return (
								t &&
								ue.string(t.title) &&
								(void 0 === t.diagnostics || ue.typedArray(t.diagnostics, g.is)) &&
					...
					(e.create = function (e, t) {
						...
						(e.is = function (e) {
							...
							return (
								ue.defined(t) &&
								r.is(t.range) &&
								(ue.undefined(t.command) || b.is(t.command))
							);
						});
				})(ie || (ie = {})),
				(function (e) {
					(e.create = function (e, t) {
						...
						(e.is = function (e) {
							var t = e;
							return (
								ue.defined(t) && ue.number(t.tabSize) && ue.boolean(t.insertSpaces)
							);
						});
				})(re || (re = {})),
				(function (e) {
				...
				((se = oe || (oe = {})).create = function (e, t) {
					return { range: e, parent: t };
				}),
				(se.is = function (e) {
					var t = e;
					return (
						void 0 !== t && r.is(t.range) && (void 0 === t.parent || se.is(t.parent))
					);
				}),
				(function (e) {
					function t(e, n) {
					...
					(e.create = function (e, t, n, i) {
						...
						(e.applyEdits = function (e, n) {
							for (
								...
								(i = i.substring(0, l) + s.newText + i.substring(c, i.length)),
									(a = l);
							}
							return i;
						});
						...
						(e.prototype.getLineOffsets = function () {
							return (
								void 0 === this._lineOffsets &&
									(this._lineOffsets = Te(this._content, !0)),
								this._lineOffsets
							);
						}),
						(e.prototype.positionAt = function (e) {
			...
			function ye(e, t) {
				...
				var n = (e.length / 2) | 0,
					...
					r = e.slice(n);
				ye(i, t), ye(r, t);
				for (var a = 0, o = 0, s = 0; a < i.length && o < r.length; ) {
					var l = t(i[a], r[o]);
					e[s++] = l <= 0 ? i[a++] : r[o++];
				}
			...
			!(function (e) {
				...
				((we = fe || (fe = {}))[(we.StartCommentTag = 0)] = 'StartCommentTag'),
				(we[(we.Comment = 1)] = 'Comment'),
				(we[(we.EndCommentTag = 2)] = 'EndCommentTag'),
				(we[(we.StartTagOpen = 3)] = 'StartTagOpen'),
				(we[(we.StartTagClose = 4)] = 'StartTagClose'),
				(we[(we.StartTagSelfClose = 5)] = 'StartTagSelfClose'),
				(we[(we.StartTag = 6)] = 'StartTag'),
				(we[(we.EndTagOpen = 7)] = 'EndTagOpen'),
				(we[(we.EndTagClose = 8)] = 'EndTagClose'),
				(we[(we.EndTag = 9)] = 'EndTag'),
				(we[(we.DelimiterAssign = 10)] = 'DelimiterAssign'),
				(we[(we.AttributeName = 11)] = 'AttributeName'),
				(we[(we.AttributeValue = 12)] = 'AttributeValue'),
				(we[(we.StartDoctypeTag = 13)] = 'StartDoctypeTag'),
				(we[(we.Doctype = 14)] = 'Doctype'),
				(we[(we.EndDoctypeTag = 15)] = 'EndDoctypeTag'),
				(we[(we.Content = 16)] = 'Content'),
				(we[(we.Whitespace = 17)] = 'Whitespace'),
				(we[(we.Unknown = 18)] = 'Unknown'),
				(we[(we.Script = 19)] = 'Script'),
				(we[(we.Styles = 20)] = 'Styles'),
				(we[(we.EOS = 21)] = 'EOS'),
				(function (e) {
			...
			var xe = I(),
						...
						(e.prototype.skipWhitespace = function () {
							return (
								this.advanceWhileChar(function (e) {
									return e === Pe || e === Oe || e === Ue || e === De || e === We;
								}) > 0
							);
						}),
				...
				Pe = ' '.charCodeAt(0),
				Oe = '\t'.charCodeAt(0),
				qe = { 'text/x-handlebars-template': !0 };
			function Ne(e, t, n, i) {
				void 0 === t && (t = 0),
				...
				function f() {
					var e,
						t = c.pos();
					if (c.eos()) return m(t, fe.EOS);
					switch (h) {
						case ge.WithinComment:
							return c.advanceIfChars([Ee, Ee, ze])
								? ((h = ge.WithinContent), m(t, fe.EndCommentTag))
								: (c.advanceUntilChars([Ee, Ee, ze]), m(t, fe.Comment));
						case ge.WithinDoctype:
							return c.advanceIfChar(ze)
								? ((h = ge.WithinContent), m(t, fe.EndDoctypeTag))
								: (c.advanceUntilChar(ze), m(t, fe.Doctype));
						case ge.WithinContent:
							if (c.advanceIfChar(Ae)) {
								if (!c.eos() && c.peekChar() === Le) {
									if (c.advanceIfChars([Le, Ee, Ee]))
										return (h = ge.WithinComment), m(t, fe.StartCommentTag);
									if (c.advanceIfRegExp(/^!doctype/i))
										return (h = ge.WithinDoctype), m(t, fe.StartDoctypeTag);
								}
								return c.advanceIfChar(Re)
									? ((h = ge.AfterOpeningEndTag), m(t, fe.EndTagOpen))
									: ((h = ge.AfterOpeningStartTag), m(t, fe.StartTagOpen));
							}
							return c.advanceUntilChar(Ae), m(t, fe.Content);
						case ge.AfterOpeningEndTag:
							return p().length > 0
								? ((h = ge.WithinEndTag), m(t, fe.EndTag))
								: c.skipWhitespace()
								? m(
										t,
										fe.Whitespace,
						...
						case ge.WithinEndTag:
							if (c.skipWhitespace()) return m(t, fe.Whitespace);
							if (c.advanceIfChar(ze))
								return (h = ge.WithinContent), m(t, fe.EndTagClose);
							if (i && c.peekChar() === Ae)
								return (
									(h = ge.WithinContent),
									m(
							...
							e = xe('error.closingBracketExpected', 'Closing bracket expected.');
							break;
						case ge.AfterOpeningStartTag:
							return (
								...
								(s = void 0),
								o.length > 0
									? ((a = !1), (h = ge.WithinTag), m(t, fe.StartTag))
									: c.skipWhitespace()
									? m(
											t,
											fe.Whitespace,
						...
						case ge.WithinTag:
							return c.skipWhitespace()
								? ((a = !0), m(t, fe.Whitespace))
								: a &&
								  (s = c
										.advanceIfRegExp(/^[^\s"'></=\x00-\x0F\x7F\x80-\x9F]*/)
										.toLowerCase()).length > 0
								? ((h = ge.AfterAttributeName), (a = !1), m(t, fe.AttributeName))
								: c.advanceIfChars([Re, ze])
								? ((h = ge.WithinContent), m(t, fe.StartTagSelfClose))
								: c.advanceIfChar(ze)
								? ((h =
										'script' === o
											? l && qe[l]
						...
						case ge.AfterAttributeName:
							return c.skipWhitespace()
								? ((a = !0), m(t, fe.Whitespace))
								: c.advanceIfChar(Ie)
								? ((h = ge.BeforeAttributeValue), m(t, fe.DelimiterAssign))
								: ((h = ge.WithinTag), f());
						case ge.BeforeAttributeValue:
							if (c.skipWhitespace()) return m(t, fe.Whitespace);
							var n = c.advanceIfRegExp(/^[^\s"'`=<>]+/);
							if (n.length > 0)
								return (
									c.peekChar() === ze &&
										c.peekChar(-1) === Re &&
										(c.goBack(1), (n = n.substr(0, n.length - 1))),
									'type' === s && (l = n),
									(h = ge.WithinTag),
									(a = !1),
									m(t, fe.AttributeValue)
								);
							var r = c.peekChar();
							return r === Ce || r === He
								? (c.advance(1),
								  c.advanceUntilChar(r) && c.advance(1),
								  'type' === s && (l = c.getSource().substring(t + 1, c.pos() - 1)),
								  (h = ge.WithinTag),
								  (a = !1),
								  m(t, fe.AttributeValue))
								: ((h = ge.WithinTag), (a = !1), f());
						case ge.WithinScriptContent:
							for (var d = 1; !c.eos(); ) {
								var u = c.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
							...
							return (h = ge.WithinContent), t < c.pos() ? m(t, fe.Script) : f();
			...
			function $e(e, t) {
				...
				return (Ge <= n && n <= Ve) || (Ke <= n && n <= Je) || (Ye <= n && n <= Xe);
			}
			var Ze = [
				'area',
				'base',
			...
			function ut(e, t, n, i) {
				for (var r = Ne(e, t, n), a = r.scan(); a === fe.Whitespace; ) a = r.scan();
				return a === i;
			}
			!(function () {
				function e(e, t) {
				...
				(e.prototype.setCompletionParticipants = function (e) {
					...
					(e.prototype._doComplete = function (e, t, n, a) {
						...
						for (var E, A = m.scan(); A !== fe.EOS && m.getTokenOffset() <= d; ) {
							switch (A) {
										...
										return (
											0 === t.line &&
												...
												o.items.push({
													...
													kind: P.Property,
													documentation:
														'A preamble for an HTML document.',
									...
									for (
										var o = function (o) {
												...
												if (
													...
													return (
														(s.contents = i(s.contents)), { value: s }
													);
											},
											l = 0,
											c = s;
			...
			var _t = /^\w[\w\d+.-]*$/,
				...
				St = (function () {
					...
					return (
						...
						(e.file = function (e) {
							var t = yt;
							if ((ft && (e = e.replace(/\\/g, Tt)), e[0] === Tt && e[1] === Tt)) {
				...
				tags: [
					...
					},
					{
						...
						attributes: [
							...
							{
								name: 'name',
								description: { kind: 'markdown', value: 'The name of the control.' }
							},
							{
								name: 'placeholder',
								description: {
			...
			!(function () {
				...
				(e.prototype.setDataProviders = function (e, t) {
					var n;
					(this.dataProviders = []),
						e && this.dataProviders.push(new tt('html5', Ut)),
			...
			var Wt = (function () {
				function e(e, t, n) {
					...
					var r = function (e) {
						...
						a = function (e) {
							E.j6.setModelMarkers(e, i._languageId, []);
							var t = e.uri.toString(),
								n = i._listener[t];
							n && (n.dispose(), delete i._listener[t]);
						};
					this._disposables.push(E.j6.onDidCreateModel(r)),
						this._disposables.push(
							E.j6.onWillDisposeModel(function (e) {
								a(e);
							})
						),
						this._disposables.push(
							E.j6.onDidChangeModelLanguage(function (e) {
								a(e.model), r(e.model);
							})
						),
						this._disposables.push(
							n.onDidChange(function (e) {
								E.j6.getModels().forEach(function (e) {
						...
						this._worker(e)
							.then(function (n) {
								return n.doValidation(e.toString()).then(function (n) {
									...
									E.j6.setModelMarkers(E.j6.getModel(e), t, i);
								});
							})
			...
			function Nt(e) {
				if (e) return { range: Ot(e.range), text: e.newText };
			}
			var jt = (function () {
				function e(e) {
					this._worker = e;
				...
				return (
					...
					(e.prototype.provideCompletionItems = function (e, t, n, i) {
						...
						return this._worker(r)
							.then(function (e) {
								return e.doComplete(r.toString(), Pt(t));
							})
							.then(function (n) {
								if (n) {
										...
										a = n.items.map(function (e) {
											...
											return (
												e.textEdit &&
													...
													void 0 !== t.replace
														? (n.range = {
																insert: Ot(e.textEdit.insert),
																replace: Ot(e.textEdit.replace)
														  })
														: (n.range = Ot(e.textEdit.range)),
													(n.insertText = e.textEdit.newText)),
												e.additionalTextEdits &&
													(n.additionalTextEdits = e.additionalTextEdits.map(
														Nt
													)),
												e.insertTextFormat === O.Snippet &&
													(n.insertTextRules =
														E.Mj.CompletionItemInsertTextRule.InsertAsSnippet),
												n
											);
										});
				...
				return (
					(e.prototype.provideHover = function (e, t, n) {
						...
						return this._worker(i)
							.then(function (e) {
								return e.doHover(i.toString(), Pt(t));
							})
							.then(function (e) {
								if (e) return { range: Ot(e.range), contents: Bt(e.contents) };
							});
					}),
					e
				);
			...
			function Vt(e) {
				var t = E.Mj.DocumentHighlightKind;
				switch (e) {
					case J.Read:
						return t.Read;
					case J.Write:
			...
			var Kt = (function () {
				...
				return (
					(e.prototype.provideDocumentHighlights = function (e, t, n) {
						...
						return this._worker(i)
							.then(function (e) {
								return e.findDocumentHighlights(i.toString(), Pt(t));
							})
							.then(function (e) {
								if (e)
									return e.map(function (e) {
										return { range: Ot(e.range), kind: Vt(e.kind) };
									});
							});
					}),
					e
									...
									if (e)
										return e.map(function (e) {
											return {
												...
												kind: Jt(e.kind),
												tags: [],
												range: Ot(e.location.range),
												selectionRange: Ot(e.location.range)
											};
										});
								});
						}),
									...
									if (e)
										return {
											links: e.map(function (e) {
												return { range: Ot(e.range), url: e.target };
											})
										};
								});
						}),
					...
					return (
						(e.prototype.provideDocumentFormattingEdits = function (e, t, n) {
							...
							return this._worker(i).then(function (e) {
								return e.format(i.toString(), null, $t(t)).then(function (e) {
									if (e && 0 !== e.length) return e.map(Nt);
								});
							});
						}),
						e
								...
								return e
									.format(
										...
										(function (e) {
											if (e)
												return {
													start: Pt(e.getStartPosition()),
													end: Pt(e.getEndPosition())
												};
										})(t),
										$t(n)
									)
				...
				en = (function () {
					...
					return (
						(e.prototype.provideRenameEdits = function (e, t, n, i) {
							...
							return this._worker(r)
								.then(function (e) {
									return e.doRename(r.toString(), Pt(t), n);
								})
								.then(function (e) {
									return (function (e) {
										if (e && e.changes) {
											...
											for (var n in e.changes)
												for (
													var i = E.Sf.parse(n), r = 0, a = e.changes[n];
													r < a.length;
													r++
												) {
													var o = a[r];
											...
											return (
												void 0 !== e.kind &&
													(t.kind = (function (e) {
														switch (e) {
															case h.Comment:
																return E.Mj.FoldingRangeKind
																	.Comment;
															case h.Imports:
																return E.Mj.FoldingRangeKind
																	.Imports;
															case h.Region:
																return E.Mj.FoldingRangeKind.Region;
														}
													})(e.kind)),
												t
											);
				...
				nn = (function () {
					...
					return (
						(e.prototype.provideSelectionRanges = function (e, t, n) {
							...
							return this._worker(i)
								.then(function (e) {
									return e.getSelectionRanges(i.toString(), t.map(Pt));
								})
								.then(function (e) {
									if (e)
										return e.map(function (e) {
											for (var t = []; e; )
												t.push({ range: Ot(e.range) }), (e = e.parent);
											return t;
										});
								});
						}),
			...
			function rn(e) {
				var t = new A(e),
					...
					i = e.languageId;
				E.Mj.registerCompletionItemProvider(i, new jt(n)),
					E.Mj.registerHoverProvider(i, new Gt(n)),
					E.Mj.registerDocumentHighlightProvider(i, new Kt(n)),
					E.Mj.registerLinkProvider(i, new Xt(n)),
					E.Mj.registerFoldingRangeProvider(i, new tn(n)),
					E.Mj.registerDocumentSymbolProvider(i, new Yt(n)),
					E.Mj.registerSelectionRangeProvider(i, new nn(n)),
					E.Mj.registerRenameProvider(i, new en(n)),
					'html' === i &&
						(E.Mj.registerDocumentFormattingEditProvider(i, new Zt(n)),
						E.Mj.registerDocumentRangeFormattingEditProvider(i, new Qt(n)),
						new Wt(i, n, e));
			}
			function an(e) {
				var t = [],
				...
				return (
					(r = e.languageId),
					(a = e.modeConfiguration),
					sn(n),
					a.completionItems && n.push(E.Mj.registerCompletionItemProvider(r, new jt(o))),
					a.hovers && n.push(E.Mj.registerHoverProvider(r, new Gt(o))),
					a.documentHighlights &&
						n.push(E.Mj.registerDocumentHighlightProvider(r, new Kt(o))),
					a.links && n.push(E.Mj.registerLinkProvider(r, new Xt(o))),
					a.documentSymbols && n.push(E.Mj.registerDocumentSymbolProvider(r, new Yt(o))),
					a.rename && n.push(E.Mj.registerRenameProvider(r, new en(o))),
					a.foldingRanges && n.push(E.Mj.registerFoldingRangeProvider(r, new tn(o))),
					a.selectionRanges && n.push(E.Mj.registerSelectionRangeProvider(r, new nn(o))),
					a.documentFormattingEdits &&
						n.push(E.Mj.registerDocumentFormattingEditProvider(r, new Zt(o))),
					a.documentRangeFormattingEdits &&
						n.push(E.Mj.registerDocumentRangeFormattingEditProvider(r, new Qt(o))),
					a.diagnostics && n.push(new Wt(r, o, e)),
					t.push(on(n)),
					on(t)
				);
			}
